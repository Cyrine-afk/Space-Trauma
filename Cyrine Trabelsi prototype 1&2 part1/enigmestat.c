...
{      
      ...
      SDL_BlitSurface(img2,NULL,Tab[0],&pos1);
	SDL_Flip(Tab[0]);
        ...
        if  ((*p)==2)
{       
       SDL_BlitSurface(img2,NULL,Tab[0],&pos2);
	SDL_Flip(Tab[0]); 
         ...
         if ((*p)==3)
{     
        SDL_BlitSurface(img2,NULL,Tab[0],&pos3);
	SDL_Flip(Tab[0]);
...
if (nclic==1)
{
        ...
        texte1 = TTF_RenderText_Blended(police,temps1, couleurNoire);
         SDL_BlitSurface(fond, NULL, Tab[0], &position);
        SDL_BlitSurface(texte1, NULL, Tab[0], &position1); 
        
     SDL_BlitSurface(textereste4, NULL, Tab[0], &positionreste4);
      SDL_BlitSurface(textewelcome, NULL, Tab[0], &positionwelcome);
...
SDL_BlitSurface(fond, NULL, Tab[0], &position);
         ...
         SDL_BlitSurface(texte1, NULL, Tab[0], &position1);
        SDL_BlitSurface(texte2, NULL, Tab[0], &position2); 


                    /*****************/
       SDL_BlitSurface(textereste3, NULL, Tab[0], &positionreste3); 
       SDL_BlitSurface(textewelcome, NULL, Tab[0], &positionwelcome);
...
SDL_BlitSurface(fond, NULL, Tab[0], &position);
         ...
         SDL_BlitSurface(texte1, NULL, Tab[0], &position1);
         SDL_BlitSurface(texte2, NULL, Tab[0], &position2);
         SDL_BlitSurface(texte3, NULL, Tab[0], &position3); 
                     /*****************/
         
        SDL_BlitSurface(textereste2, NULL, Tab[0], &positionreste2);
        SDL_BlitSurface(textewelcome, NULL, Tab[0], &positionwelcome);
...
SDL_BlitSurface(fond, NULL, Tab[0], &position);
         ...
         SDL_BlitSurface(texte2, NULL, Tab[0], &position2);
         SDL_BlitSurface(texte3, NULL, Tab[0], &position3);
         SDL_BlitSurface(texte4, NULL, Tab[0], &position4);
                   /*****************/
       
          SDL_BlitSurface(textereste1, NULL, Tab[0], &positionreste1);
          SDL_BlitSurface(textewelcome, NULL, Tab[0], &positionwelcome);
}
    ...
    if (k1==1)
{
    textereste5 = TTF_RenderText_Blended(police, "il vous reste 5 essais", couleurrouge);
        ...
        positionreste5.y =95;
        SDL_BlitSurface(textereste5, NULL, Tab[0], &positionreste5);  
        SDL_Flip(Tab[0]);
k1=0;
}
...
{          
         number1=0;
 nb(n10,&p1,&number1,&numero,e.nm[0],Tab,positionnum1,positionnum2,positionnum3);
 n10=1;
...
{
     number1=1;
    nb(n11,&p1,&number1,&numero,e.nm[1],Tab,positionnum1,positionnum2,positionnum3);
n11=1;
...
{
       number1=2; 
  nb(n12,&p1,&number1,&numero,e.nm[2],Tab,positionnum1,positionnum2,positionnum3);
     n12=1;  
}
...
{
     number1=3;
 nb(n13,&p1,&number1,&numero,e.nm[3],Tab,positionnum1,positionnum2,positionnum3);
     n13=1;    
}
...
{
     number1=4;
 nb(n14,&p1,&number1,&numero,e.nm[4],Tab,positionnum1,positionnum2,positionnum3);
   n14=1; 
}
...
if(a> 218 && a< 241 && b>185 && b<214)//nzel aal 5
{
  ...
  number1=5;
 nb(n15,&p1,&number1,&numero,e.nm[5],Tab,positionnum1,positionnum2,positionnum3);
n15=1;
...
{
    number1=6;
 nb(n16,&p1,&number1,&numero,e.nm[6],Tab,positionnum1,positionnum2,positionnum3);
 n16=1;
...
{
     number1=7;
 nb(n17,&p1,&number1,&numero,e.nm[7],Tab,positionnum1,positionnum2,positionnum3);
 n17=1;
...
{
          number1=8;
 nb(n18,&p1,&number1,&numero,e.nm[8],Tab,positionnum1,positionnum2,positionnum3);
 n18=1;
...
{
     number1=9;
 nb(n19,&p1,&number1,&numero,e.nm[9],Tab,positionnum1,positionnum2,positionnum3);
 n19=1;
...
recherchenum(e.img[0],&numero,nclic1,temps11,temps12,temps13,temps14,temps15,Tab,quiz);
             p1=0;
            
            n10=0,n11=0,n12=0,n13=0,n14=0,n15=0,n16=0,n17=0,n18=0,n19=0;

            SDL_BlitSurface( e.box[0],NULL,Tab[0],&e.posbox[0]);
	    SDL_Flip(Tab[0]);
            SDL_BlitSurface( e.box[0],NULL,Tab[0],&e.posbox[1]);
	    SDL_Flip(Tab[0]);
            SDL_BlitSurface( e.box[0],NULL,Tab[0],&e.posbox[2]);
	    SDL_Flip(Tab[0]);
            
           
           if(gagne(&numero,quiz)==1) 
  {
        SDL_BlitSurface(e.img[1],NULL,Tab[0],&e.posimg[1]);
	SDL_Flip(Tab[0]);
        SDL_Delay(3000);
        return 1;
     //rba7
  ...
  if ((nombre_chance1==0)&&(gagne(&numero,quiz)!=1))
{
              ...
              SDL_BlitSurface(e.img[2],NULL,Tab[0],&e.posimg[2]);
	      SDL_Flip(Tab[0]);
              SDL_Delay(3000);
              return 0;
             //khsar
...
{          
         number2=0;
 nb(n20,&p2,&number2,&numero2,e.nm[0],Tab,positionnum1,positionnum2,positionnum3);
 n20=1;
...
{
     number2=1;
    nb(n21,&p2,&number2,&numero2,e.nm[1],Tab,positionnum1,positionnum2,positionnum3);
n21=1;
...
{
       number2=2; 
  nb(n22,&p2,&number2,&numero2,e.nm[2],Tab,positionnum1,positionnum2,positionnum3);
     n22=1;  
}
...
{
     number2=3;
 nb(n23,&p2,&number2,&numero2,e.nm[3],Tab,positionnum1,positionnum2,positionnum3);
     n23=1;    
}
...
{
     number2=4;
 nb(n24,&p2,&number2,&numero2,e.nm[4],Tab,positionnum1,positionnum2,positionnum3);
   n24=1; 
}
...
if(a> 218 && a< 241 && b>185 && b<214)//nzel aal 5
{
  ...
  number2=5;
 nb(n25,&p2,&number2,&numero2,e.nm[5],Tab,positionnum1,positionnum2,positionnum3);
n25=1;
...
{
    number2=6;
 nb(n26,&p2,&number2,&numero2,e.nm[6],Tab,positionnum1,positionnum2,positionnum3);
 n26=1;
...
{
     number2=7;
 nb(n27,&p2,&number2,&numero2,e.nm[7],Tab,positionnum1,positionnum2,positionnum3);
 n27=1;
...
{
          number2=8;
 nb(n28,&p2,&number2,&numero2,e.nm[8],Tab,positionnum1,positionnum2,positionnum3);
 n28=1;
...
{
     number2=9;
 nb(n29,&p2,&number2,&numero2,e.nm[9],Tab,positionnum1,positionnum2,positionnum3);
 n29=1;
...
recherchenum(e.img[0],&numero2,nclic2,temps21,temps22,temps23,temps24,temps25,Tab,quiz2);
             p2=0;
...
{          
         number3=0;
 nb(n30,&p3,&number3,&numero3,e.nm[0],Tab,positionnum1,positionnum2,positionnum3);
 n30=1;
...
{
     number3=1;
    nb(n31,&p3,&number3,&numero3,e.nm[1],Tab,positionnum1,positionnum2,positionnum3);
n31=1;
...
{
       number3=2; 
  nb(n32,&p3,&number3,&numero3,e.nm[2],Tab,positionnum1,positionnum2,positionnum3);
     n32=1;  
}
...
{
     number3=3;
 nb(n33,&p3,&number3,&numero3,e.nm[3],Tab,positionnum1,positionnum2,positionnum3);
     n33=1;    
}
...
{
     number3=4;
 nb(n34,&p3,&number3,&numero3,e.nm[4],Tab,positionnum1,positionnum2,positionnum3);
   n34=1; 
}
...
if(a> 218 && a< 241 && b>185 && b<214)//nzel aal 5
{
  ...
  number3=5;
 nb(n35,&p3,&number3,&numero3,e.nm[5],Tab,positionnum1,positionnum2,positionnum3);
n35=1;
...
{
    number3=6;
 nb(n36,&p3,&number3,&numero3,e.nm[6],Tab,positionnum1,positionnum2,positionnum3);
 n36=1;
...
{
     number3=7;
 nb(n37,&p3,&number3,&numero3,e.nm[7],Tab,positionnum1,positionnum2,positionnum3);
 n37=1;
...
{
          number3=8;
 nb(n38,&p3,&number3,&numero3,e.nm[8],Tab,positionnum1,positionnum2,positionnum3);
 n38=1;
...
{
     number3=9;
 nb(n39,&p3,&number3,&numero3,e.nm[9],Tab,positionnum1,positionnum2,positionnum3);
 n39=1;
...
recherchenum(e.img[0],&numero3,nclic3,temps31,temps32,temps33,temps34,temps35,Tab,quiz3);
             p3=0;
